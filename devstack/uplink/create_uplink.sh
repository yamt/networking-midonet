...
# Configure host side
sudo ip addr add ${UPLINK_CIDR} dev ${UPLINK_HOST_IFNAME}
...
# REVISIT(yamamoto): This probably doesn't belong to this script.
sudo sysctl -w net.ipv4.ip_forward=1
#PUBLIC_IP=$(ip addr show dev ${PUBLIC_INTERFACE} | awk '$1=="inet" {sub("/.*", "", $2); print $2}')
#die_if_not_set $LINENO PUBLIC_IP "Failed to obtain public ip"
